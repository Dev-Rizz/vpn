...
adminip=$( curl -sS https://raw.githubusercontent.com/Dev-Rizz/auth/main/accessmenu | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/Dev-Rizz/auth1/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
