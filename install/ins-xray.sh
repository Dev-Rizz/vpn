...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/${GitUser}/auth/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/${GitUser}/auth/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/vpn/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/vpn/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/vpn/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
